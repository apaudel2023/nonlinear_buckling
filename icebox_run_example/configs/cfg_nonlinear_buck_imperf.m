...
% Configuration for Imperfect Nonlinear Buckling Analysis (SOL 105 + SOL 400 Nonlinear)
...
config.bdf_file_imperfect = fullfile('bdf_templates', 'BDF_IMPERFECT_NONLINEAR_SOL_400.bdf');
...
config.simulation_timeout400 = 600;
