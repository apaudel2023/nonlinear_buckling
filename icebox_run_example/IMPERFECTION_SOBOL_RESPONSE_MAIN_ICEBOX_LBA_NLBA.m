...
load('RESULT_LBA_PERF_SAMP_1_5E3_25D_SF_1E3_2E1.mat', 'RESULT_LBA_PERF_SAMP_1_5E3_25D_SF_1E3_2E1')
LBA_RESULTS = RESULT_LBA_PERF_SAMP_1_5E3_25D_SF_1E3_2E1; 
%%
...
for ITK = 1:20
    ...
    pause(35);    % wait until the simulation is completed using PID
    ...
    EIGENVAL_LBA_PERF = LBA_RESULTS(SAMP,3);
% % % 
% % %     try
