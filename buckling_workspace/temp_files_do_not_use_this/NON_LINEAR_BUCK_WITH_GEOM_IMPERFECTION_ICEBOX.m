...
% % % % %     
    ...
    pause(60);
    fprintf('Solution 105 Completed !!! \n');
...
% % %     fprintf('Time taken for SOL 105 = %0.2f min\n',t105/60)
    ...
    SOL_400_NONLINEAR_BUCK_FUNC_MAIN_IMPERFECTION(SF,PRE_RUN_FILE_NAME)
    ...
    copyfile('LOADS_APPLIED.dat',fullfile(pwd,'/SOL400','LOADS_APPLIED.dat'));
