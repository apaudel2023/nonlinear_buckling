function SOL_400_IMPF_NLBA_FUNC_MAIN(SCALE_FACTOR,PRE_RUN_FILE_NAME, IMPF_FILE_NAME_NLBA)
%% CREATE NEW .DAT FILE
%FID_400 = fopen('IMP_CYLINDER_SOL400.dat','w'); %% NEW DAT FILE
...
% SF_TEMP = logspace(-3,2,10);
% sf_mean = 0.1;
% SF_TEMP = sort(sf_mean + (sf_mean*0.1).*randn(10,1),'ascend')
% SF_TEMP = 0.3;
% CONST = 2555.2;
% SCALING_FACTOR = CONST * (1-SF_TEMP);
% [SF_TEMP' SCALING_FACTOR']
% SCALING_FACTOR=SF_TEMP
% SCALING_FACTOR = 0;
% SCALING_FACTOR = 0.90;
